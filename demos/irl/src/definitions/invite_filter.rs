...
pub struct InviteFilter {
    ...
    featured_image: String, /* varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
                    * DEFAULT NULL, */
    ...
    card_image: String, /* varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
                         * DEFAULT NULL, */
    full_screen_image: String, /* varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
                                * DEFAULT NULL, */
    circle_image: String, /* varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
                           * DEFAULT NULL, */
    icon_image: String, /* varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT
                         * NULL, */
    unsplash_image: String, /* varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
                             * DEFAULT NULL, */
}
