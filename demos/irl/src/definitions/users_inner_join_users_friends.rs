...
#[allow(dead_code)]
pub struct UserInnerJoinUsersFriends {
    ...
    avatar: String,   /*  varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT
                       * 'users/default.png', */
    ...
    // `users_friends` columns
    uf_user_id: i64,        // int DEFAULT NULL,
    uf_friend_id: i64,      // int DEFAULT NULL,
    uf_is_deleted: i64,     // tinyint(1) DEFAULT '0',
    uf_ignored: i64,        // tinyint(1) DEFAULT '0',
    uf_blocked: i64,        // tinyint(1) DEFAULT '0',
    uf_created_at: String,  // timestamp NULL DEFAULT NULL,
    uf_updated_at: String,  // timestamp NULL DEFAULT NULL,
    uf_requested: i64,      // tinyint(1) NOT NULL DEFAULT '0',
    uf_request_denied: i64, // tinyint NOT NULL DEFAULT '0',
}

impl FromRow for UserInnerJoinUsersFriends {
    fn from_row_opt(row: Row) -> Result<Self, FromRowError>
    where
        Self: Sized,
    {
        Ok(UserInnerJoinUsersFriends {
            id: get!(row, 0),
            role_id: get!(row, 1),
            first: get!(row, 2),
            last: get!(row, 3),
            ...
            uf_user_id: get!(row, 46),
            uf_friend_id: get!(row, 47),
            uf_is_deleted: get!(row, 48),
            uf_ignored: get!(row, 49),
            uf_blocked: get!(row, 50),
            uf_created_at: get!(row, 51),
            uf_updated_at: get!(row, 52),
            uf_requested: get!(row, 53),
            uf_request_denied: get!(row, 54),
        })
    }
}
