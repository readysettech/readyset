...
#[allow(dead_code)]
pub struct UserInnerJoinUsersGroups {
...
impl FromRow for UserInnerJoinUsersGroups {
    fn from_row_opt(row: Row) -> Result<Self, FromRowError>
    where
        Self: Sized,
    {
        Ok(UserInnerJoinUsersGroups {
            id: get!(row, 0),
            role_id: get!(row, 1),
            first: get!(row, 2),
            last: get!(row, 3),
            ...
            ug_group_id: get!(row, 46),
            ug_user_id: get!(row, 47),
            ug_joined_at: get!(row, 48),
            ug_pending: get!(row, 49),
            ug_inviter_id: get!(row, 50),
            ug_is_seen: get!(row, 51),
            ug_deleted_at: get!(row, 52),
            ug_is_requested: get!(row, 53),
            ug_denied_at: get!(row, 54),
            ug_created_at: get!(row, 55),
            ug_updated_at: get!(row, 56),
        })
    }
}
