...
enum WalState {
    ...
    Unflushed {
        /// The replication offset up to which this state has been flushed to disk
        flushed_up_to: ReplicationOffset,
    },
}
...
impl WalFlusher {
    ...
    fn flush_wal(&self, flushed_up_to: ReplicationOffset) {
        ...
        //
        // Note that flushing the WAL blocks writes to RocksDB anyway, so our write lock doesn't
