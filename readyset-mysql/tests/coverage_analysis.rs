//! Tests for query coverage analysis and testing support in readyset-mysql
//!
//! see: <https://docs.google.com/document/d/1i2HYLxANhJX4BxBnYeEzLO6sTecE4HkLoN31vXDlFCM/edit>

use mysql_async::prelude::Queryable;
use readyset_client_test_helpers::mysql_helpers::setup;
...
async fn mirror_reads_with_unsupported_query() {
    ...
    // this query will likely always be unsupported, so should fail in ReadySet but succeed in mysql
