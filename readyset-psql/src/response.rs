...
/// A simple wrapper around ReadySet client's `PrepareResult`, facilitating conversion to
...
/// A simple wrapper around ReadySet client's `QueryResult`, facilitating conversion to
