...
pub struct Row {
    /// The values comprising the row, as returned from a ReadySet interface lookup. Only the indices
    ...
    /// The fields to project. A `Vec<DataType>` returned from a ReadySet interface lookup may
