...
impl RawReplayPath {
    ...
    /// Returns the number of segments in this replay path
    ...
    /// Returns a slice of the actual segments in this replay path
    ...
    match dcs.ancestors.len() {
        ...
        1 => {
            ...
            if dcs.break_path && current.len() > 1 {
                ...
                if current_colref.node == next_colref.node {
...
mod tests {
    ...
    #[test]
    #[ignore] // Straddled join remapping temporarily disabled for now
