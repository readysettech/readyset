...
impl NoriaBackendInner {
    ...
    /// view will be retrieve from ReadySet.
...
impl PrepareResult {
    /// Get the ReadySet statement id for this statement
...
pub struct NoriaConnector {
    ...
    /// The region to pass to ReadySet for replica selection.
...
impl NoriaConnector {
    ...
    /// this function is the only way to create a view in ReadySet.
