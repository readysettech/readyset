...
use readyset_server::{Builder, DurabilityMode, NoriaMetricsRecorder, VolumeId};
...
struct Opts {
    ...
    /// Use the AWS EC2 metadata service to determine the external address of this ReadySet instance.
    ///
    ...
    /// Sets the number of concurrent replay requests in a readyset-server.
    #[clap(long, hide = true)]
