...
use readyset_errors::{internal_err, rpc_err, view_err, ReadySetError, ReadySetResult};
...
pub enum ViewPlaceholder {
    /// This key column was generated by ReadySet, and has no mapping to the original query. This is
...
pub struct ViewSchema {
    ...
    /// The set of columns projected at the ReadySet flowgraph reader node.
...
pub enum SchemaType {
    ...
    /// query.
    ReturnedSchema,
    /// Used to select the schema projected at the ReadySet flowgraph reader node.
    ProjectedSchema,
}
...
pub struct ReplicaShard {
    ...
    /// by the readyset-server, where the shard lives in.
