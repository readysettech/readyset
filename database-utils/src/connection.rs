            ...
            Self::MySql(stmt) => {
                fn column_to_sqltype(c: &mysql_async::Column) -> SqlType {
                    ...
                    match (
                        ...
                        (MYSQL_TYPE_TINY, true) => SqlType::TinyIntUnsigned(None),
                        (MYSQL_TYPE_SHORT, true) => SqlType::SmallIntUnsigned(None),
                        (MYSQL_TYPE_INT24, true) => SqlType::MediumIntUnsigned(None),
                        (MYSQL_TYPE_LONG, true) => SqlType::IntUnsigned(None),
                        (MYSQL_TYPE_LONGLONG, true) => SqlType::BigIntUnsigned(None),
            ...
            Self::Postgres(stmt, _) => {
                fn pg_type_to_sqltype(c: &tokio_postgres::types::Type) -> SqlType {
                    ...
                    match c {
                        ...
                        &Type::CIDR_ARRAY => SqlType::Array(Box::new(SqlType::Cidr)),
