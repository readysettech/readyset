...
resource "aws_ram_resource_share" "prod-default-us-east-2" {
  allow_external_principals = false
  name                      = "prod-default-us-east-2"
  tags = {
    Environment      = "prod"
    Manager          = "Terraform"
    Name             = "prod-default"
...
resource "aws_ram_resource_association" "prod-default-private-us-east-2a" {
  resource_arn       = aws_subnet.prod-default-private-us-east-2a.arn
  resource_share_arn = aws_ram_resource_share.prod-default-us-east-2.arn
}

resource "aws_ram_resource_association" "prod-default-private-us-east-2b" {
  resource_arn       = aws_subnet.prod-default-private-us-east-2b.arn
  resource_share_arn = aws_ram_resource_share.prod-default-us-east-2.arn
}

resource "aws_ram_resource_association" "prod-default-private-us-east-2c" {
  resource_arn       = aws_subnet.prod-default-private-us-east-2c.arn
  resource_share_arn = aws_ram_resource_share.prod-default-us-east-2.arn
}

resource "aws_ram_resource_association" "prod-default-public-us-east-2a" {
  resource_arn       = aws_subnet.prod-default-public-us-east-2a.arn
  resource_share_arn = aws_ram_resource_share.prod-default-us-east-2.arn
}

resource "aws_ram_resource_association" "prod-default-public-us-east-2b" {
  resource_arn       = aws_subnet.prod-default-public-us-east-2b.arn
  resource_share_arn = aws_ram_resource_share.prod-default-us-east-2.arn
}

resource "aws_ram_resource_association" "prod-default-public-us-east-2c" {
  resource_arn       = aws_subnet.prod-default-public-us-east-2c.arn
  resource_share_arn = aws_ram_resource_share.prod-default-us-east-2.arn
}

resource "aws_ram_principal_association" "prod-default-us-east-2" {
