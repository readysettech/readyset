...
resource "aws_ram_resource_share" "atlantis-sandbox-default" {
  allow_external_principals = false
  name                      = "atlantis-sandbox-default"
...
resource "aws_ram_principal_association" "atlantis-sandbox-default" {
  principal          = "305232526136"
  provider           = aws.network
  resource_share_arn = aws_ram_resource_share.atlantis-sandbox-default.arn
}
