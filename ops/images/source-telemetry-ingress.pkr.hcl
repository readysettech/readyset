locals {
  telemetry_ingress_ami_name = format("readyset/images/%s-ssd/telemetry-ingress-%s-amd64-%s",
...
source "amazon-ebs" "telemetry-ingress" {
  ...
  ami_name                  = local.telemetry_ingress_ami_name
