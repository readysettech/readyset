locals {
  ...
  # Prod is needed to actually run production software
  ami_users = [
    local.deploy_account_id,
    local.build_account_id,
    local.sandbox_account_id,
    local.network_account_id,
