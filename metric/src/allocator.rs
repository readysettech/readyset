...
/// Gauge: Total number of bytes in virtual memory mappings that were retained rather than being
...
/// Gauge: Total number of bytes that are in active pages but are not "allocated" by the process.
