...
mod _verify_expansion {
    // ── Explicit variants ──
    use super::mysql_all::{mysql57, mysql80, mysql84, mysql97};
    use super::mysql_modern::{mysql80 as _m80, mysql84 as _m84, mysql97 as _m97};
    use super::mysql_modern_gtid::{mysql80_gtid, mysql84_gtid, mysql97_gtid};
    use super::mysql_modern_mrbr::{mysql80_mrbr, mysql84_mrbr, mysql97_mrbr};
    use super::mysql_modern_nogtid::{mysql80_nogtid, mysql84_nogtid, mysql97_nogtid};
    ...
    // mysql97 (from mysql_all) → three (no __xp_nogtid; GTID defaults to ON in 9.5+)
    use super::mysql_all::mysql84__xp_nogtid as _;
    use super::mysql_all::mysql97__xp_gtid as _;
    use super::mysql_all::mysql97__xp_mrbr as _;
    use super::mysql_all::mysql97__xp_mrbr_gtid as _;
    ...
    // mysql97 (from mysql_modern) → three (no __xp_nogtid; GTID defaults to ON in 9.5+)
    use super::mysql_modern::mysql84__xp_nogtid as _mm84_nogtid;
    use super::mysql_modern::mysql97__xp_gtid as _mm97_gtid;
    use super::mysql_modern::mysql97__xp_mrbr as _mm97_mrbr;
    use super::mysql_modern::mysql97__xp_mrbr_gtid as _mm97_mrbr_gtid;
    ...
    use super::mysql_modern_gtid::mysql97__xp_mrbr_gtid as _g97xp;
    ...
    use super::mysql_modern_mrbr::mysql97__xp_mrbr_gtid as _mr97xp;
