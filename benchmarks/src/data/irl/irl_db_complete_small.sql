SET @user_rows = 15000;
SET @invites_hashtags_rows = 2000;
SET @hashtag_rows = 2000;
SET @invites_users_rows = 4000;
SET @invites_rows = 10000;
SET @group_rows = 5000;
SET @user_auth_tokens_rows = 4000;
...
CREATE TABLE `_users_groups_del` (
  `id` bigint unsigned NOT NULL,
  `user_id` int unsigned NOT NULL COMMENT 'UNIFORM 0 @user_rows',
  `group_id` int unsigned NOT NULL COMMENT 'UNIFORM 0 @group_rows',
...
CREATE TABLE `ab_tests_users` (
  `id` bigint unsigned NOT NULL,
  `user_id` bigint unsigned NOT NULL COMMENT 'UNIFORM 0 @user_rows',
...
CREATE TABLE `group_rules` (
  ...
  `group_id` bigint unsigned NOT NULL COMMENT 'UNIFORM 0 @group_rows',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `groups` (
  ...
  UNIQUE KEY `other_user_id_user_id_unique` (`other_user_id`,`user_id`),
  KEY `user_id_index` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT = 'ROWS=@group_rows';
...
) ENGINE=InnoDB AUTO_INCREMENT=2000 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT = 'ROWS=@hashtag_rows';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT = 'ROWS=@invites_rows';
...
CREATE TABLE `invites_hashtags` (
  `id` int unsigned NOT NULL,
  `invite_id` int COMMENT 'UNIFORM 0 @invites_rows',
  `user_id` int COMMENT 'UNIFORM 0 @user_rows',
  `hashtag_id` int COMMENT 'UNIFORM 0 @hashtag_rows',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_composite_index` (`hashtag_id`,`invite_id`),
  KEY `invite_id` (`invite_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT = 'ROWS=@invites_hashtags_rows';
...
CREATE TABLE `invites_users` (
  `id` bigint unsigned NOT NULL,
  `user_id` int COMMENT 'UNIFORM 0 @user_rows',
  `group_id` int COMMENT 'UNIFORM 0 @group_rows',
  `invite_id` int NOT NULL COMMENT 'UNIFORM 0 @invites_rows',
  `attending` tinyint(1),
...
CREATE TABLE `paid_group_seeded_data` (
  `id` bigint unsigned NOT NULL,
  `group_id` int NOT NULL COMMENT 'UNIFORM 0 @group_rows',
  `price_in_cents` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `user_auth_tokens` (
  `id` int unsigned NOT NULL,
  `user_id` int NOT NULL COMMENT 'UNIFORM 0 @user_rows',
  ...
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT = 'ROWS=@user_auth_tokens_rows';
...
CREATE TABLE `users` (
  ...
  KEY `picture` (`picture`),
  KEY `updated_at` (`updated_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT = 'ROWS=@user_rows';
