...
use readyset_data::rls_repo::try_apply_rls;
...
impl SqlIncorporator {
    ...
    fn select_query_to_mir_inner(
        ...
        // Store the QueryId of the input statement
        let query_id = QueryId::from_select(stmt, search_path);
        ...
        *stmt = self.rewrite(
        ...
        if try_apply_rls(query_id.into(), &mut rls_stmt)? {
