...
pub trait AdapterRewriteContext:
    ResolveSchemasContext + RewriteDialectContext + StarExpansionContext
{
}
    ...
    mod rewrite_query {
        ...
        fn numbered_where_in_with_auto_params() {
            ...
            assert_eq!(
                query,
                parse_select_statement_postgres(
                    "SELECT t3.x, t3.y, t3.z, t3.w, t3.q FROM t3 WHERE x = $1 AND y = $2 AND z = $3 AND w = $4 AND q = $5",
                )
            );
        ...
        fn numbered_auto_parameterized_in() {
            ...
            assert_eq!(
                query,
                parse_select_statement_postgres(
                    "SELECT users.id, users.name, users.credit_card_number FROM users WHERE name = $1 AND id = $2 AND credit_card_number = $3",
                )
            );
        ...
        fn numbered_not_in_order_auto_param() {
            ...
            assert_eq!(
                query,
                parse_select_statement_postgres(
                    "SELECT t2.x, t2.y, t2.z FROM t2 WHERE x = $1 AND y = $2 AND z = $3"
                ),
                "{}",
        ...
        fn bare_offset_zero() {
            ...
            assert_eq!(
                query,
                parse_select_statement_postgres("SELECT t.x, t.y FROM t WHERE x = $1"),
                "{}",
                query.display(Dialect::PostgreSQL)
            );
        ...
        fn reuses_params_basic() {
            ...
            assert_eq!(
                query,
                parse_select_statement_postgres("SELECT t.x, t.y FROM t WHERE x = $1 AND y = $2"),
                "{}",
                query.display(Dialect::PostgreSQL)
            );
