...
use crate::{
    ArrayConstructorRewrite as _, ImpliedTableExpansion as _, ImpliedTablesContext,
    ResolveSchemas as _, ResolveSchemasContext, RewriteDialectContext, StarExpansion as _,
    StarExpansionContext, ValidateWindowFunctions as _,
};
...
pub trait AdapterRewriteContext:
    ImpliedTablesContext + ResolveSchemasContext + RewriteDialectContext + StarExpansionContext
{
}
...
mod tests {
    ...
    mod rewrite_query {
        ...
        impl ResolveSchemasContext for TestAdapterRewriteContext {
            fn add_invalidating_table(&self, _table: readyset_sql::ast::Relation) {
                // no-op
            }
        ...
        impl StarExpansionContext for TestAdapterRewriteContext {
            fn schema_for_relation(
                &self,
                relation: &readyset_sql::ast::Relation,
            ...
            fn is_relation_non_replicated(&self, _relation: &readyset_sql::ast::Relation) -> bool {
                false
            }
        }
        ...
        impl ImpliedTablesContext for TestAdapterRewriteContext {
            fn all_schemas(
                ...
                Item = (
                    readyset_sql::ast::Relation,
                    Vec<readyset_sql::ast::SqlIdentifier>,
                ),
            > {
                vec![
                    (
