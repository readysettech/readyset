...
pub use post_lookup_decomposition::{
...
mod tests {
    ...
    mod avg_decomposition {
        ...
        use super::*;
        use crate::adapter_rewrites::post_lookup_decomposition::{
            PostLookupAggregateKind, decompose_aggregates_for_post_lookup,
        };
