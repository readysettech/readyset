...
use crate::{ResolveSchemas as _, ResolveSchemasContext, RewriteDialectContext};
...
pub trait AdapterRewriteContext: ResolveSchemasContext + RewriteDialectContext {}
...
mod tests {
    ...
    mod resolve_schemas_integration {
        ...
        fn resolve_schemas_leaves_unknown_table_unqualified() {
            ...
            let mut query =
                parse_select_statement("SELECT * FROM nonexistent", Dialect::PostgreSQL);
