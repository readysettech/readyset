            ...
            fn test_write_timestamp_tz() {
                fn arbitrary_stable_timezone() -> impl Strategy<Value = Tz> {
                    prop_oneof![
                        ...
                        Just(Tz::Asia__Kabul),
                        Just(Tz::Asia__Qatar),
                        Just(Tz::Asia__Ho_Chi_Minh), // replaces Saigon
                        Just(Tz::Asia__Seoul),
                        ...
                        Just(Tz::Pacific__Chatham), // replaces NZCHAT
