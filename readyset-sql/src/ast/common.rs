    ...
    fn try_from_dialect(
        ...
        match value {
            Check { name, expr } => Ok(Self::CheckConstraint {
                constraint_name: name.map(|name| name.into_dialect(dialect)),
            ...
            FulltextOrSpatial {
                ...
                index_name: opt_index_name.map(|name| name.into_dialect(dialect)),
                columns: columns
                    .into_iter()
                    .map(|name| name.into_dialect(dialect))
                    .collect(),
            ...
            PrimaryKey {
                ...
                constraint_name: name.map(|name| name.into_dialect(dialect)),
                index_name: index_name.map(|name| name.into_dialect(dialect)),
                columns: columns
                    .into_iter()
                    .map(|name| name.into_dialect(dialect))
                    .collect(),
